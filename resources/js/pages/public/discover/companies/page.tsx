...
export default function SearchResult({
    ...
    const handleClearFilters = () => {
        ...
        setVerified(false);
        setSort('newest');
        router.get('/companies', { tab: filters.tab || 'all' });
    };
...
return;
    ...
    return (
        <GuestLayout>
            <Head>
                <title>Companies Search - SoukNet</title>
                                    ...
                                    {businesses.data.length === 0 ? (
                                        <tr>
                                            <td colSpan={9} className="p-12 text-center text-[#8f9bba]">
                                                ...
                                                <h3 className="font-bold text-white text-sm">No Companies Found</h3>
                                        ...
                                        businesses.data.map((business) => {
                                            ...
                                            const isSaved = savedCompanyIds.includes(business.id);
                                                ...
                                                <tr key={business.id} className={`hover:bg-[#15171e]/40 transition-colors ${isSelected ? 'bg-[#4318FF]/5' : ''}`}>
                                                    ...
                                                    <td className="p-3 text-center">
                                                        <button
                                                            ...
                                                            title={isSaved ? 'Unsave Company' : 'Save Company'}
                                                        >
                                                            <Bookmark className="h-3.5 w-3.5" />
                                                        </button>
                                                    </td>
