    ...
    return (
        <GuestLayout>
            ...
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-48px)] bg-[#15171e] text-white p-6 relative overflow-hidden font-['Inter',_sans-serif]">
                ...
                <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-amber-600/10 rounded-full blur-[100px] pointer-events-none" />
                ...
                <div className="max-w-md w-full text-center relative z-10 space-y-6">
                    ...
                    <div className="inline-flex items-center justify-center p-5 rounded-2xl bg-gradient-to-br from-[#22252e] to-[#0c0d12] border border-[#262930] shadow-2xl relative group transition-all duration-300 hover:scale-105">
                        <div className="absolute inset-0 bg-gradient-to-r from-amber-500/20 to-[#4318FF]/20 rounded-2xl blur opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                        <FileText className="h-10 w-10 text-amber-400 relative z-10" />
                    </div>

                    <div className="space-y-3">
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-amber-500/10 text-amber-300 border border-amber-500/20 animate-pulse">
                        ...
                        <p className="text-sm text-[#8f9bba] max-w-sm mx-auto leading-relaxed">
                            Build high-converting forms to capture, route, and enrich directory leads directly into your workspace. Coming soon to SoukNet.
                        </p>
                    </div>
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row items-center gap-3 justify-center">
                        ...
                        <button
                            onClick={() => alert('Thanks for your interest! We will notify you when Forms launches.')}
                            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-600 to-[#4318FF] hover:from-amber-500 hover:to-[#5028ff] text-xs font-bold text-white shadow-lg shadow-indigo-950/50 hover:shadow-indigo-500/10 transition-all hover:translate-y-[-1px]"
                        >
                            Notify Me
                        </button>
                    </div>
