                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-10 text-center md:text-left md:flex md:items-center md:justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-zinc-400 max-w-2xl">
                                Find verified companies, expert services, and local stores in our verified directory database.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
                        ...
                        <div className="lg:col-span-3 space-y-6">
                            {/* Mobile Filters Trigger & Search Bar */}
                            ...
                            {/* Active search badges summaries */}
                            ...
                            {/* Business Count & Sort label */}
                            <div className="flex items-center justify-between text-xs text-zinc-400">
                                <div>
                                    Showing <span className="text-zinc-200 font-semibold">{businesses.from || 0}-{businesses.to || 0}</span> of <span className="text-zinc-200 font-semibold">{businesses.total}</span> businesses
                                </div>
                                <div className="hidden sm:flex items-center gap-1.5">
                                    <ArrowUpDown className="h-3 w-3" />
                                    <span>Sorted by:</span>
                                    <span className="text-zinc-200 font-semibold capitalize">{sort.replace('_', ' ')}</span>
                                </div>
                            </div>
                            ...
                            {businesses.data.length === 0 ? (
                                <div className="rounded-xl border border-dashed border-[#2E2E2E] p-12 text-center">
                                    ...
                                    <h3 className="font-semibold text-white">No businesses found</h3>
                                    <p className="mt-1 text-sm text-zinc-400 max-w-sm mx-auto">
                                        Try adjusting your search query, choosing a different category, or removing filters.
                                    </p>
                                                ...
                                                <div className="relative aspect-video w-full overflow-hidden bg-zinc-900 border-b border-[#1F1F1F]">
                                                    {business.photos && business.photos.length > 0 ? (
                                                        ...
                                                        <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-zinc-900 via-[#161616] to-[#0A0A0A] text-zinc-600">
                                                            <Building2 className="h-8 w-8 opacity-40 group-hover:scale-110 transition-transform duration-300" />
                                                        </div>
                                                    )}
                                                    ...
                                                    <div>
                                                        <div className="flex items-start justify-between gap-2">
                                                            ...
                                                            {business.is_verified && (
                                                                <CheckCircle className="h-4.5 w-4.5 text-emerald-400 shrink-0 mt-0.5" title="Verified business" />
                                                            )}
                                                        </div>
                                                        {business.tagline && (
